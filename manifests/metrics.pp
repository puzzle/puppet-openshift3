class openshift3::metrics {
  ...
  if versioncmp($::openshift3::version, "3.1") > 0 {
    ...
    if $::openshift3::metrics_image_version {
      $image_version = ",IMAGE_VERSION=${::openshift3::metrics_image_version}"
    } else {
      $image_version = ""
    }
    ...
    instantiate_template { "metrics-deployer-template":
      ...
      template_parameters => "HAWKULAR_METRICS_HOSTNAME=${::openshift3::metrics_domain},USE_PERSISTENT_STORAGE=${::openshift3::metrics_use_persistent_storage}${image_version},CASSANDRA_PV_SIZE=${::openshift3::metrics_pv_size},METRIC_DURATION=${::openshift3::metrics_duration}",
